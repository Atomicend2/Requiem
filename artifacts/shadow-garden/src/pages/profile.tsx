...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500">
      {/* Header Profile Card */}
      <div className="rounded-xl relative overflow-hidden border border-primary/20 shadow-[0_0_60px_rgba(225,29,72,0.08)]">
          ...
          <div className="-mt-20 md:-mt-24 shrink-0 ring-4 ring-black rounded-full">
            {avatarUrl ? (
              <img
                src={avatarUrl}
                alt="avatar"
                className="w-24 h-24 md:w-32 md:h-32 rounded-full object-cover border-2 border-primary shadow-[0_0_20px_rgba(225,29,72,0.5)]"
              />
            ) : (
              <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-black border-2 border-primary shadow-[0_0_20px_rgba(225,29,72,0.4)] flex items-center justify-center text-4xl md:text-5xl font-serif text-primary">
...
const THEME_COLORS: Record<string, string> = {
  celestial: "border-rose-500/60 shadow-[0_0_18px_rgba(225,29,72,0.35)]",
