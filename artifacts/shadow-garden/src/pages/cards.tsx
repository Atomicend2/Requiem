...
const TIER_CONFIG: Record<string, { label: string; bg: string; text: string; border: string; glow: string; rate: string }> = {
  ...
  "T3": { label: "Rare",      bg: "bg-rose-500/20",    text: "text-rose-400",    border: "border-rose-500/40",    glow: "shadow-[0_0_12px_rgba(56,189,248,0.5)]",   rate: "15%" },
  ...
  "T6": { label: "Animated",  bg: "bg-violet-500/20",   text: "text-violet-300",   border: "border-violet-400/50",   glow: "shadow-[0_0_22px_rgba(34,211,238,0.7)]",   rate: "—"   },
    ...
    <div className="min-h-screen p-4 md:p-8 max-w-7xl mx-auto">
      ...
      <Tabs defaultValue="all" className="w-full">
        <TabsList className="flex w-full max-w-2xl bg-black/40 border border-primary/10 p-1 gap-1 overflow-x-auto mb-6">
          ...
          <TabsTrigger value="fusion" className="flex-1 data-[state=active]:bg-rose-500/20 data-[state=active]:text-rose-400 font-bold tracking-wider uppercase text-xs rounded-sm whitespace-nowrap">Fusion</TabsTrigger>
              ...
              <div className="text-center py-12 glass-card rounded-xl border border-amber-500/30 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Button className="bg-rose-500/20 hover:bg-rose-500/40 text-rose-400 border border-rose-500/50 font-bold tracking-widest uppercase px-8 h-12 shadow-[0_0_20px_rgba(225,29,72,0.3)]">
...
function LockedPanel({ color, icon, title, desc, badge }: { color: string; icon: React.ReactNode; title: string; desc: string; badge: string }) {
  ...
  const iconBg: Record<string, string> = {
    ...
    sky:   "bg-rose-500/10 border-rose-500/30 shadow-[0_0_30px_rgba(225,29,72,0.25)]",
