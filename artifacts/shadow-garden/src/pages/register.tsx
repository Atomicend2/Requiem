  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-background">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgba(225,29,72,0.08),transparent)]" />
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-4xl font-bold bg-gradient-to-br from-rose-300 via-primary to-violet-300 bg-clip-text text-transparent neon-text-sky tracking-widest uppercase mb-2">
            REQUIEM ORDER
          </h1>
